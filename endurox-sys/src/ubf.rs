...
impl UbfBuffer {
    ...
    pub fn change_string(&mut self, field_id: i32, occ: i32, value: &str) -> Result<(), String> {
        ...
        if result == -1 {
            return Err(format!("Failed to change string field {} at occ {}", field_id, occ));
        }
    ...
    pub fn get_string(&self, field_id: i32, occ: i32) -> Result<String, String> {
        ...
        if result == -1 {
            return Err(format!("Failed to get string field {} at occ {}", field_id, occ));
        }
    ...
    pub fn get_long(&self, field_id: i32, occ: i32) -> Result<i64, String> {
        ...
        if result == -1 {
            return Err(format!("Failed to get long field {} at occ {}", field_id, occ));
        }
    ...
    pub fn get_double(&self, field_id: i32, occ: i32) -> Result<f64, String> {
        ...
        if result == -1 {
            return Err(format!("Failed to get double field {} at occ {}", field_id, occ));
        }
    ...
    pub fn delete(&mut self, field_id: i32, occ: i32) -> Result<(), String> {
        ...
        if result == -1 {
            return Err(format!("Failed to delete field {} at occ {}", field_id, occ));
        }
