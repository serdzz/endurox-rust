...
extern "C" {
    ...
    #[cfg(feature = "server")]
    pub fn tpadvertise_full(svcname: *const c_char, func: extern "C" fn(*mut TpSvcInfoRaw), funcname: *const c_char) -> c_int;
    ...
    #[cfg(feature = "client")]
    pub fn tpcall(svc: *const c_char, idata: *mut c_char, ilen: c_long, odata: *mut *mut c_char, olen: *mut c_long, flags: c_long) -> c_int;
    
    #[cfg(feature = "client")]
    pub fn tpacall(svc: *const c_char, data: *mut c_char, len: c_long, flags: c_long) -> c_int;
    
    #[cfg(feature = "client")]
    pub fn tpgetrply(cd: *mut c_int, data: *mut *mut c_char, len: *mut c_long, flags: c_long) -> c_int;
